...
### Hard rules for Codex — never violate these
...
- Codex is ALWAYS called after the anonymiser, never before
...
1. **AI Solutions Prize (Quantium)** — three-stage AI pipeline: SLM anonymisation, Codex humanisation, Elastic vector semantic retrieval
